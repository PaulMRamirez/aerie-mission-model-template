...
This is an **Aerie Mission Model Template** for NASA's Aerie framework. It provides scaffolding for building mission models and scheduling/constraint procedures that can be uploaded to Aerie.
...
├── docker-compose.yml     # Full Aerie stack for local development
...
Procedural libraries from `gov.nasa.ammos.aerie.procedural`:
...
- `build.gradle` - Root build config with Aerie version management
...
3. Upload to Aerie via UI or API
4. Create scheduling/constraint procedures referencing your activity types
5. Build procedure JARs and upload to Aerie
